...
class TextBotMessage:
    ...
    START_MSG = "\n".join(
        [
            ...
            'Чтобы добавить свой вес нужно отправить сообщение, например, "85.1 кг"',
    ...
    SECOND_START_MSG_FOR_NEW_USER = (
        "Перед тем как начать вести подсчет калорий, нам нужно узнать твой текущий вес в "
        'килограммах. Для этого введи текст - "N кг", где N - твой текущий вес'
    )
    SUCCESS_REGISTRATION_MSG = (
        "Отлично! Теперь ты готов контролировать свою физическую активность и килокалории. "
