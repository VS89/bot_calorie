...
class TestCalorieBalanceMsg:
    ...
    @pytest.mark.parametrize('user_calorie_count, kcal_sum, exp_text_msg',
    ...
    def test_calorie_balance_msg(self, user_calorie_count, kcal_sum, exp_text_msg):
        """
        Проверяем разные тексты для разного баланса ккал
        """
        kcal_balance = user_calorie_count - kcal_sum - LimitValues.CALORIE_DEFICIT
